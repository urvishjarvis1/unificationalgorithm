 ...
 * @Class members variables expression1,expression2,tempMap,resultMap,failed_due_to_occurance,failed_due_to_syntax
 * @author urvis
 */
public class AI_Assignment_1 {
    /**
     * expression1 -> stores the first expression passed by user.
     * expression2 -> stores the first expression passed by user.
     */
    ...
    /**
     * Takes expressions passed by user and separates the string input by chars and pushed it into the stacks. 
    ...
    /**
     * Unification algorithm which takes two expression as stacks and compare character by character to unify the terms.
     ...
     * @param specialCase = special case when the right side of result needs to be substitute in the expression.
     */
